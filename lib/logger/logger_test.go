...
func TestLoggerForMap(t *testing.T) {
	...
	logM := logger.InfoWithContext(context.Background(), map[string]interface{}{
		...
		"name":     "pawananjani",
		"lastname": "kumar",
		"email":    "pawananjani.kumar@goniyo.com",
	})

	if logM != `{"appPackageId":"","application":"appname","clientDeviceId":"","clientPlatform":"","clientSessionId":"","clientVersion":"","correlationId":"correlationid","level":"INFO","loggerName":"","message":"\"hello\" {\"email\":\"pawananjani.kumar@goniyo.com\",\"integer\":1,\"lastname\":\"kumar\",\"name\":\"pawananjani\"}","principal":"userid","spanId":"","timestamp":0,"traceId":""}` {
...
func TestLoggerForSliceMap(t *testing.T) {
	...
	logM := logger.InfoWithContext(context.Background(), map[string]interface{}{
		...
		},
		{
			"firstName": "shivank",
			"lastName":  "singhal",
			"email":     "shivank.kumar@goniyo.com",
		},
	})
	if logM != `{"appPackageId":"","application":"appname","clientDeviceId":"","clientPlatform":"","clientSessionId":"","clientVersion":"","correlationId":"correlationid","level":"INFO","loggerName":"","message":"\"hello\" [{\"email\":\"pawananjani.kumar@goniyo.com\",\"firstName\":\"pawananjani\",\"lastName\":\"kumar\"},{\"email\":\"shivank.kumar@goniyo.com\",\"firstName\":\"shivank\",\"lastName\":\"singhal\"}]","principal":"userid","spanId":"","timestamp":0,"traceId":""}` {
		t.Errorf("log mismatch for logging for map")
	}
}
